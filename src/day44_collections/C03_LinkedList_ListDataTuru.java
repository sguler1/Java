...
public class C03_LinkedList_ListDataTuru {
    public static void main(String[] args) {
        ...
        // Eğer listemiz Integer elementlerden oluşuyorsa
        // doğrudan sayı yazarsak indeks olarak kabul eder.
        // Bir variable'a atama yapar ve remove'da o variable'ın ismini yazarsak obje olarak kabul eder.
