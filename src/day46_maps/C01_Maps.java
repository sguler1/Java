...
public class C01_Maps {
    public static void main(String[] args) {
        ...
        System.out.println(sinifList); // {101=Ali, Can, JDev, 102=Enes, Cem, QA, 103=Taha, Emre, JDev, 104=Derya, Deniz, Tester}
        ...
        // Mapde bulunan öğrencilerin isim ve soyisimlerini birleştirerek bir sınıf listesi oluşturun
